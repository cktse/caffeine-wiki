...
date_ingested: [e.g. 2026-08-24]
tags: [e.g. personal-log, brewing, neo-switch, natural, ethiopia, gesha]
...
roast_level: [claimed/label, e.g. Light]
agtron_whole: [measured, whole bean, e.g. 75.8]
agtron_ground: [measured, ground, e.g. 95.2]
notes: [e.g. Jasmine; Tangerine; White Grape]
weight: [purchased, e.g. 100g]
cost: [currency + amount paid, e.g. HKD 190]
purchased_date: [e.g. 2026-08-23]
purchased_from: [e.g. Entrebox physical store]
