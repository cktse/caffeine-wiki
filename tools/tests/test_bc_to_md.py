...
check("compute_ey", bc.compute_ey(216, 1.4, 15) == 20.2)
check("compute_ey_missing_bev", bc.compute_ey(0, 1.4, 15) is None)
...
check("append_new_row_present", "2026-01-07" in body and "| 90 °C |" in body, "brew-a2 row missing")
