---
title: "ZHAW Coffee Excellence Center"
entity_type: org
domain: brewing
---
...
Measured the **particle size distributions** for the Kaffeemacher 24-grinder study on a Retsch **Camsize X2** imaging device (Marco Wellinger), providing the raw data behind [[brewing/sources/gagne-grinder-psd-analysis-2023]]. A high-credibility academic anchor for grind/PSD science — the grinding counterpart to the wiki's [[brewing/entities/uc-davis-coffee-center|UC Davis]] anchor for brewing.
