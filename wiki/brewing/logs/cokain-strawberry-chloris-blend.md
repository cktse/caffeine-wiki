---
title: Cokain Strawberry Chloris (Blend)
source_type: personal_log
raw_path: raw/brewing/Cokain Coffee Blend – Strawberry Chloris – 集氣箱 Entrebox.md
...
url: https://en.entreboxhk.com/shop/cokain-coffee-blend-strawberry-chloris-250g/
---

# Cokain Strawberry Chloris (Blend)
...
None specific — the seller only suggests it works as espresso, with milk, or pour-over.

## Brewing Logs

### 2026-08-24 — [[brewing/entities/decent-espresso|Decent Espresso XL]] · Blooming Espresso

| Grind | Dose | Yield | Ratio | Temp | Pressure | Time | TDS | EY |
|---|---|---|---|---|---|---|---|---|
| O78S @ 4 | 15 g | 45 g | 1:3 | 95 °C | **<3 bar (too low)** | — | — | — |
...
- Once it pulls cleanly, measure TDS/EY and log sensory vs. the seller's strawberry / red-wine / rose / yogurt.
